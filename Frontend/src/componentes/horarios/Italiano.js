...
const Italiano = () => {
    var miArrayRecuperado = JSON.parse(localStorage.getItem("Italiano"));
    const [tableData, setTableData] = useState(miArrayRecuperado);
  return (
    <>
      <h1 style={{marginTop: '10px', textAlign: 'center', backgroundColor: 'lightblue', height: '70px'}}>Horarios Italiano</h1>;
